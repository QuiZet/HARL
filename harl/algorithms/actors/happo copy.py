...
class HAPPO(OnPolicyBase):
    ...
    def update(self, sample):
        ...
        print(f'HAPPO::update policy_loss:{policy_loss}')
        print(f'HAPPO::update dist_entropy:{dist_entropy}')
        print(f'HAPPO::update actor_grad_norm:{actor_grad_norm}')
        print(f'HAPPO::update imp_weights:{imp_weights}')
    ...
    def train(self, actor_buffer, advantages, state_type):
        ...
        """
        print(f'HAPPO::train actor_buffer:{actor_buffer}')
        print(f'HAPPO::train advantages:{advantages}')
        print(f'HAPPO::train state_type:{state_type}')
        train_info = {}
        ...
        print(f'HAPPO::train train_info:{train_info}')
        return train_info
